...
let colorHtml = " "
//retrieves value of selected option
let modeValue = mode.options[mode.selectedIndex].value

//function returns selected alphanumeric hex seed color without # infront
// substring extracts characters between two indices (positions) from a string & returns the substring.
...
//updates the modeValue (selected option) to the new value chosen    
